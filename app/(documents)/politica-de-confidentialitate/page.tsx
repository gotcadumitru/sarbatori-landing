...
const PrivacyPolicy = () => (
  <div className={styles.page}>
    ...
    <h2>
      <strong className={styles.strong}> Consentiment</strong>
    </h2>
    <p className={styles.paragraph}>
    ...
    <h2>
      <strong className={styles.strong}> Informațiile pe care le colectăm</strong>
    </h2>
    <p className={styles.paragraph}>
    ...
    <h2>
      <strong className={styles.strong}> Cum utilizăm informațiile dvs.</strong>
    </h2>
    <p className={styles.paragraph}>
