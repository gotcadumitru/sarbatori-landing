...
const TermsAndConditionsEN: FC = () => (
  <div className={classes.page}>
    <h1>
      <strong className={classes.strong}>Terms and Conditions</strong>
    </h1>
    <p className={classes.paragraph}>Welcome to DIMA'S SOFTWARE!</p>
    <p className={classes.paragraph}>
      These terms and conditions outline the rules and regulations for the use of DIMA'S SOFTWARE's
      website, located at https://www.sarbatori.net.
    </p>
    <p className={classes.paragraph}>
      By accessing this website, we assume you accept these terms and conditions. Do not continue to
      use the website if you do not agree to take all the terms and conditions stated on this page.
    </p>
    <p className={classes.paragraph}>
      The following terminology applies to these Terms and Conditions, Privacy Statement and
      Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person
      logging on this website and compliant to the Company’s terms and conditions. "The Company",
      ...
      of md. Any use of the above terminology or other words in the singular, plural, capitalization
      and/or he/she or they, are taken as interchangeable and therefore as referring to same.
    </p>
    <h3>
      <strong className={classes.strong}>Cookies</strong>
    </h3>
    <p className={classes.paragraph}>
      We employ the use of cookies. By accessing the website, you agreed to use cookies in agreement
    ...
    <h3>
      <strong className={classes.strong}>License</strong>
    </h3>
    <p className={classes.paragraph}>
      Unless otherwise stated, DIMA'S SOFTWARE and/or its licensors own the intellectual property
      rights for all material on the website. All intellectual property rights are reserved. You may
      access this from the website for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>
    <p className={classes.paragraph}>You must not:</p>
    <ul>
      <li>Republish material from the website</li>
      <li>Sell, rent or sub-license material from the website</li>
      <li>Reproduce, duplicate or copy material from the website</li>
      <li>Redistribute content from DIMA'S SOFTWARE</li>
    </ul>
    <p className={classes.paragraph}>This Agreement shall begin on the date hereof.</p>
    <p className={classes.paragraph}>
      Parts of this website offer an opportunity for users to post and exchange opinions and
      information in certain areas of the website. DIMA'S SOFTWARE does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views and
      opinions of DIMA'S SOFTWARE, its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, DIMA'S SOFTWARE shall not be liable for the Comments or for any liability,
      damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
      appearance of the Comments on this website.
    </p>
    <p className={classes.paragraph}>
      DIMA'S SOFTWARE reserves the right to monitor all Comments and to remove any Comments which
      can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
    </p>
    <p className={classes.paragraph}>You warrant and represent that:</p>
    <ul>
      <li>
    ...
    <p className={classes.paragraph}>
      You hereby grant DIMA'S SOFTWARE a non-exclusive license to use, reproduce, edit and authorize
      others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
    </p>
    <h3>
      <strong className={classes.strong}>Hyperlinking to our Content</strong>
    </h3>
    <p className={classes.paragraph}>
    ...
    <p className={classes.paragraph}>
      ...
      visibility of the hyperlink compensates the absence of DIMA'S SOFTWARE; and (d) the link is in
    ...
    <p className={classes.paragraph}>
      ...
      to our website, you must inform us by sending an e-mail to DIMA'S SOFTWARE. Please include
    ...
    <p className={classes.paragraph}>
      No use of DIMA'S SOFTWARE's logo or other artwork will be allowed for linking absent a
    ...
    <h3>
      <strong className={classes.strong}>Content Liability</strong>
    </h3>
    <p className={classes.paragraph}>
    ...
    <h3>
      <strong className={classes.strong}>Reservation of Rights</strong>
    </h3>
    <p className={classes.paragraph}>
    ...
    <h3>
      <strong className={classes.strong}>Removal of links from our website</strong>
    </h3>
    <p className={classes.paragraph}>
    ...
    <h3>
      <strong className={classes.strong}>Disclaimer</strong>
    </h3>
    <p className={classes.paragraph}>
