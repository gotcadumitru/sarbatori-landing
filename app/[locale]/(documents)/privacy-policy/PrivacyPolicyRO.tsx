...
const PrivacyPolicyRO = () => (
  <div className={classes.page}>
    ...
    <p className={classes.paragraph}>
      ...
      noastră de Confidențialitate, nu ezitați să ne contactați.
    </p>
    <p className={classes.paragraph}>
    ...
    <h2>
      <strong className={classes.strong}> Consentiment</strong>
    </h2>
    <p className={classes.paragraph}>
      Prin utilizarea site-ului nostru web, vă dați consimțământul cu privire la Politica noastră de
      Confidențialitate și acceptați termenii acesteia.
    </p>
    <h2>
      <strong className={classes.strong}> Informațiile pe care le colectăm</strong>
    </h2>
    <p className={classes.paragraph}>
      Informațiile personale pe care vi se solicită să le furnizați și motivele pentru care vi se
      solicită să le furnizați vor fi clarificate la momentul în care vi se cere să furnizați
      informațiile personale.
    </p>
    <p className={classes.paragraph}>
      Dacă ne contactați direct, putem primi informații suplimentare despre dvs., cum ar fi numele
      dvs., adresa de email, numărul de telefon, conținutul mesajului și/sau atașamentele pe care ni
      le puteți trimite și orice alte informații pe care alegeți să ni le furnizați.
    </p>
    <p className={classes.paragraph}>
      Când vă înregistrați pentru un cont, vă putem solicita informații de contact, inclusiv
      elemente precum numele, numele companiei, adresa, adresa de email și numărul de telefon.
    </p>
    <h2>
      <strong className={classes.strong}> Cum utilizăm informațiile dvs.</strong>
    </h2>
    <p className={classes.paragraph}>
      Utilizăm informațiile pe care le colectăm în diverse moduri, inclusiv pentru:
    </p>
    <ul>
      <li>Oferi, opera și menține site-ul nostru web</li>
      <li>Îmbunătățirea, personalizarea și extinderea site-ului nostru web</li>
      <li>Înțelegerea și analizarea modului în care utilizați site-ul nostru web</li>
      <li>Dezvoltarea de produse, servicii, caracteristici și funcționalități noi</li>
      <li>
        Comunicarea cu dvs., fie direct, fie prin intermediul unuia dintre partenerii noștri,
        inclusiv pentru serviciul pentru clienți, pentru a vă furniza actualizări și alte informații
        referitoare la site-ul web și în scopuri de marketing și promovare
      </li>
      <li>Trimiterea de emailuri</li>
      <li>Găsirea și prevenirea fraudelor</li>
    </ul>
    <h2>
      <strong className={classes.strong}> Fișierele de Jurnal (Log Files)</strong>
    </h2>
    <p className={classes.paragraph}>
    ...
    <h2>
      <strong className={classes.strong}> Partenerii noștri de Publicitate</strong>
    </h2>
    <p className={classes.paragraph}>
    ...
    <h2>
      <strong className={classes.strong}> Drepturile de Protecție a Datelor GDPR</strong>
    </h2>
    <p className={classes.paragraph}>
    ...
    <h2>
      <strong className={classes.strong}> Informații despre Copii</strong>
    </h2>
    <p className={classes.paragraph}>
    ...
    <h2>
      <strong className={classes.strong}> Contactați-ne</strong>
    </h2>
    <p className={classes.paragraph}>
    ...
    <p className={classes.paragraph}>
      Pentru orice intrebare sau detaliu ce implica securitatea datelor utilizatorilor HoliDays va
