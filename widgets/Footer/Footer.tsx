...
export const Footer: FC<FooterProps> = ({ className }) => (
  <div className={classNames(classes.footer, className)}>
    <div className={classNames(classes.footerContainer, 'container')}>
      <FooterColumn title={"DIMA'S SOFTWARE"}>
      ...
      <FooterColumn title='Înscrie-te la newsletter'>
        Dorești să fii mereu informat cu privire la cele mai recente dezvoltări și noutăți legate de
        aplicațiile noastre DIMA'S SOFTWARE? Lasă-ne adresa ta de email, iar noi ne vom asigura că
        vei fi mereu la curent cu cele mai proaspete informații, actualizări și oferte exclusive.
        <ContactUs />
      </FooterColumn>
    </div>
    <div className='container'>
      <div className={classes.copyright}>Copyright © DIMA'S SOFTWARE. All Rights Reserved.</div>
    </div>
  </div>
)
